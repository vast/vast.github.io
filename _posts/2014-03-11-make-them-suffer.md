...
Взвалите на их плечи как можно больше. Сведите рутинные задачи к одной единственной команде с помощью алиасов, скриптов, макросов и шаблонов:

```bash
$ fs tail staging    # 3 секунды, показать логи приложения с сервера
$ fs setup rails foo # 4 секунды, создать новый Rails проект foo
```
